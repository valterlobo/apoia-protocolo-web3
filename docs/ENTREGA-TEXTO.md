O APOIA é um protocolo Web3 de crowdfunding descentralizado com Escrow trustless, token $AGT, NFTs ERC-1155, ApoiaDAO e oráculo Chainlink.

**Entregáveis:**

1. **Relatório Técnico PDF:** Arquitetura e deploy na Sepolia. 

    https://github.com/valterlobo/apoia-protocolo-web3/blob/main/docs/RelatorioTecnico.pdf
